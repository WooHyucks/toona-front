      ...
      <div className="shrink-0 px-4 pt-4 md:px-6">
        ...
        >
          ...
          <input
            ...
            className="h-12 w-full rounded-2xl border border-border bg-card pl-10 pr-10 text-[14px] text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
          />
          {query ? (
            <button
              type="button"
